...
<?php endif; ?>
	<li class="et-social-icon et-social-linkedin">
		<a href="https://www.linkedin.com/company-beta/24984170/" class="icon" target="_blank">
			<span><?php esc_html_e( 'Linkedin', 'Divi' ); ?></span>
		</a>
	</li>
	<li class="et-social-icon et-social-instagram">
		<a href="https://www.instagram.com/pilgrimroadcreative/" class="icon" target="_blank">
